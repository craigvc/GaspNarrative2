...
void UNarrativeComponent::PrepareForSave_Implementation()
{
...
void UNarrativeComponent::Load_Implementation()
{
	if (SavedQuests.Num())
	{
		PerformLoad();
...
void UNarrativeComponent::PerformLoad()
{
...
void UNarrativeComponent::ClientReceiveSave_Implementation(const TArray<FNarrativeSavedQuest>& InSavedQuests, const TArray<FString>& Tasks, const TArray<int32>& Quantities)
{
