...
#include "NarrativeNavigatorEditor/Public/NavigatorFunctionLibrary.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeNavigatorFunctionLibrary() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_UBlueprintFunctionLibrary();
NARRATIVENAVIGATOREDITOR_API UClass* Z_Construct_UClass_UNavigatorFunctionLibrary();
NARRATIVENAVIGATOREDITOR_API UClass* Z_Construct_UClass_UNavigatorFunctionLibrary_NoRegister();
UNREALED_API UClass* Z_Construct_UClass_UTexture2DFactoryNew_NoRegister();
UPackage* Z_Construct_UPackage__Script_NarrativeNavigatorEditor();
...
UObject* (*const Z_Construct_UClass_UNavigatorFunctionLibrary_Statics::DependentSingletons[])() = {
	...
	(UObject* (*)())Z_Construct_UPackage__Script_NarrativeNavigatorEditor,
};
...
template<> NARRATIVENAVIGATOREDITOR_API UClass* StaticClass<UNavigatorFunctionLibrary>()
{
	return UNavigatorFunctionLibrary::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeNavigatorEditor_Public_NavigatorFunctionLibrary_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNavigatorFunctionLibrary, UNavigatorFunctionLibrary::StaticClass, TEXT("UNavigatorFunctionLibrary"), &Z_Registration_Info_UClass_UNavigatorFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNavigatorFunctionLibrary), 2350645508U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeNavigatorEditor_Public_NavigatorFunctionLibrary_h_3823783044(TEXT("/Script/NarrativeNavigatorEditor"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeNavigatorEditor_Public_NavigatorFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeNavigatorEditor_Public_NavigatorFunctionLibrary_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
