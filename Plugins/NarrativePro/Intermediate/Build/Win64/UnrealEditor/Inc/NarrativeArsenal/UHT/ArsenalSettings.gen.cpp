...
struct Z_Construct_UClass_UArsenalSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bHolsterWeaponOnEquip_MetaData[] = {
		{ "Category", "Narrative Pro|Gameplay Functionality" },
		{ "Comment", "///**If true, equipped weapons will be holstered upon equip. Otherwise, they will be out on equip. */\n" },
		{ "ModuleRelativePath", "Public/ArsenalSettings.h" },
		{ "ToolTip", "If true, equipped weapons will be holstered upon equip. Otherwise, they will be out on equip." },
	};
...
#endif // WITH_METADATA
	static void NewProp_bHolsterWeaponOnEquip_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bHolsterWeaponOnEquip;
...
void Z_Construct_UClass_UArsenalSettings_Statics::NewProp_bHolsterWeaponOnEquip_SetBit(void* Obj)
{
	((UArsenalSettings*)Obj)->bHolsterWeaponOnEquip = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UArsenalSettings_Statics::NewProp_bHolsterWeaponOnEquip = { "bHolsterWeaponOnEquip", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UArsenalSettings), &Z_Construct_UClass_UArsenalSettings_Statics::NewProp_bHolsterWeaponOnEquip_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bHolsterWeaponOnEquip_MetaData), NewProp_bHolsterWeaponOnEquip_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UArsenalSettings_Statics::NewProp_GameEntryMap = { "GameEntryMap", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UArsenalSettings, GameEntryMap), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GameEntryMap_MetaData), NewProp_GameEntryMap_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UArsenalSettings_Statics::NewProp_UIPrimaryColor = { "UIPrimaryColor", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UArsenalSettings, UIPrimaryColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_UIPrimaryColor_MetaData), NewProp_UIPrimaryColor_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UArsenalSettings_Statics::NewProp_UIInvertColor = { "UIInvertColor", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UArsenalSettings, UIInvertColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_UIInvertColor_MetaData), NewProp_UIInvertColor_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UArsenalSettings_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArsenalSettings_Statics::NewProp_bHolsterWeaponOnEquip,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArsenalSettings_Statics::NewProp_UIPrimaryColor,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArsenalSettings_Statics::NewProp_UIInvertColor,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UArsenalSettings, UArsenalSettings::StaticClass, TEXT("UArsenalSettings"), &Z_Registration_Info_UClass_UArsenalSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UArsenalSettings), 4106105997U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_343013993(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
